...
from codes.trainflow import EmotionFlow
...
if __name__ == '__main__':
    ...
    download = False
    init = False
    dataset_dict = {'easy_label': True, "train_type": "v1"}
    ...
    for lr in [5e-5, 3e-5, 2e-5]:
        ...
        emb_type = 'bert'
        flow = EmotionFlow(dataset_dict=dataset_dict, model_dict=model_dict, emb_type=emb_type,
                        parallel=True, 
                        model='Entailment',
