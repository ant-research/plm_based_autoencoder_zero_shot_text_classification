...
from model.discrete_vae.models.simple_module import one_hot_argmax, PackedSequneceUtil
...
class ConcreteRelaxation(nn.Module):
    ...
    def forward(self, logits_q):
        ...
        if self.tau_mode == "anneal" and self.training:
            ...
            self.tau = torch.FloatTensor(self.tau.shape).fill_(tau_value).to(self.tau.device)
