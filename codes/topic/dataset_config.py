...
class TopicDataConfig():
    def __init__(self, easy_label=False, train_type = 'v0'):
        self.task_type = 'Single_Label'

        # dataset download and path config
        if easy_label:
            self.dataset_oss_data_path = 'topic'
            self.dataset_oss_emb_path = 'topic/emb_output'
        else:
            self.dataset_oss_data_path = 'topic'
            self.dataset_oss_emb_path = 'topic/emb_output'
        self.dataset_local_data_path = './data/topic'
        # unlabeled data
...
class TopicDataConfig_W2V(TopicDataConfig):
...
class TopicDataConfig_BERT_T(TopicDataConfig):
    def __init__(self, easy_label=False, emb_type='bert', train_type="v0"):
        ...
        self.bert_oss_path = 'pretrained_model/topic_bert_pretrained/'  # remote oss bert path
...
class TopicDataConfig_BERT_P(TopicDataConfig):
...
class TopicDataConfig_GPT(TopicDataConfig):
    def __init__(self, emb_type='gpt', easy_label=False, train_type="v0"):
        super().__init__(easy_label=easy_label, train_type=train_type)
        self.task_type = 'Single_Label'
        # embedding config
        self.gpt2_path = './pretrained_model/gpt2'  # bert save path
        self.gpt2_oss_path = 'pretrained_model/topic_gpt_pretrained'  # remote oss bert path
...
class TopicDataConfig_Local(TopicDataConfig):
...
class TopicDataConfig_BERT_T_LOCAL(TopicDataConfig):
    def __init__(self, easy_label=False, emb_type='bert'):
        super().__init__(easy_label=easy_label)
        self.task_type = 'Single_Label'
        # embedding config
        self.bert_path = '../models/topic_bert_pretrained'  # bert save path
...
class TopicDataConfig_BERT_P_LOCAL(TopicDataConfig):
    def __init__(self, emb_type='bert', easy_label=False):
...
class TopicDataConfig_GPT_LOCAL(TopicDataConfig):
    def __init__(self, emb_type='gpt', easy_label=False):
        super().__init__(easy_label)
        self.task_type = 'Single_Label'
        # embedding config
        self.gpt2_path = '../models/topic_gpt_pretrained'  # bert save path
...
TopicDataConfigDICT = {
    'w2v': TopicDataConfig_W2V,
    # 'bert_t': TopicDataConfig_BERT_T,
    # 'bert_p': TopicDataConfig_BERT_P,
    # 'gpt2': TopicDataConfig_GPT,
    'bert_t': TopicDataConfig_BERT_T_LOCAL,
    'bert_p': TopicDataConfig_BERT_P_LOCAL,
    'gpt2': TopicDataConfig_GPT_LOCAL,
}
