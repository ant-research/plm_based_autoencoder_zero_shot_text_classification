...
class Situation_Dataset(Dataset):
    """
    dataset类
    """
...
class Situation_Idx_Dataset(Situation_Dataset):
    """
    dataset类
    """
    def __init__(self, dataset_config, data_type, emb_layer, logger, label=False, init=False, debug=False, local=True):
...
class Situation_Idx_Entailment_Dataset(Situation_Dataset):
    """
    dataset类
    """
    def __init__(self, dataset_config, data_type, emb_layer, logger, label=False, init=False, debug=False, local=True):
...
class Situation_Idx_Label_dataset(Situation_Dataset):
    '''
...
class Situation_Generated_Dataset(Dataset):
    '''
    generated class and result
    '''
...
class Situation_Generated_Enailment_Dataset(Dataset):
    '''
    generated class and result
    '''
    def __init__(self, class_num, dataset_config):
        ...
        self.class_num = class_num
        label_csv = pd.read_csv(dataset_config.label_local_path)
        self.y_text = ['A news with %s situation' % str(label_name) for label_name in list(label_csv['label'])]
...
class Situation_Unlabeled_Dataset(Dataset):
    """
    dataset类
    """
...
class Situation_Idx_Unlabeled_Dataset(Situation_Unlabeled_Dataset):
    """
    dataset类
    """
    def __init__(self, dataset_config, emb_layer, debug=False, local=False, init=False):
