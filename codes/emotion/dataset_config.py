...
class EmotionDataConfig():
    def __init__(self, easy_label=False, train_type = 'v0'):
        ...
        if easy_label:
            self.dataset_oss_data_path = 'cunyin/emotion'
            self.dataset_oss_emb_path = 'cunyin/emotion/emb_output'
        else:
            self.dataset_oss_data_path = 'cunyin/emotion'
            self.dataset_oss_emb_path = 'cunyin/emotion/emb_output'
        self.dataset_local_data_path = './data/emotion'
        # unlabeled data
        ...
        for data_type in ['train', 'eval', 'test']:
            if data_type == 'train':
                print("train type is", train_type)
                if train_type == "v0":
...
class EmotionDataConfig_W2V(EmotionDataConfig):
    def __init__(self, emb_type='bert', easy_label=False, train_type = 'v0'):
        ...
        self.w2v_oss_path = 'cunyin/pretrained_model/w2v_wos'
...
class EmotionDataConfig_BERT_T(EmotionDataConfig):
    def __init__(self, easy_label=False, emb_type='bert', train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        self.task_type = 'Single_Label'
        # embedding config
        self.bert_path = './pretrained_model/bert_t'  # bert save path
        self.bert_oss_path = 'cunyin/pretrained_model/emotion_bert_pretrained/'  # remote oss bert path
...
class EmotionDataConfig_BERT_P(EmotionDataConfig):
    def __init__(self, emb_type='bert', easy_label=False, train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        self.task_type = 'Single_Label'
        # embedding config
...
class EmotionDataConfig_GPT(EmotionDataConfig):
    def __init__(self, emb_type='gpt', easy_label=False, train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        self.task_type = 'Single_Label'
        # embedding config
        self.gpt2_path = './pretrained_model/gpt2'  # bert save path
        self.gpt2_oss_path = 'cunyin/pretrained_model/emotion_gpt_pretrained'  # remote oss bert path
...
class EmotionDataConfig_BERT_T_LOCAL(EmotionDataConfig):
    def __init__(self, easy_label=False, emb_type='bert', train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        self.task_type = 'Single_Label'
        # embedding config
        self.bert_path = './models/emo_bert'  # bert save path
...
class EmotionDataConfig_BERT_P_LOCAL(EmotionDataConfig):
    def __init__(self, emb_type='bert', easy_label=False, train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        self.task_type = 'Single_Label'
        # embedding config
...
class EmotionDataConfig_GPT_LOCAL(EmotionDataConfig):
    def __init__(self, emb_type='gpt', easy_label=False, train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        self.task_type = 'Single_Label'
        # embedding config
        self.gpt2_path = './models/emo_gpt'  # bert save path
...
class EmotionDataConfig_Local(EmotionDataConfig):
    def __init__(self, emb_type='bert', easy_label=False, train_type = 'v0'):
        super().__init__(easy_label=easy_label, train_type = train_type)
        # dataset download and path config
...
EmotionDataConfigDICT = {
    'w2v': EmotionDataConfig_W2V,
    'bert_t': EmotionDataConfig_BERT_T_LOCAL,
    'bert_p': EmotionDataConfig_BERT_P_LOCAL,
    'gpt2': EmotionDataConfig_GPT_LOCAL,
}
